...
-- Mô tả: Script tạo database và dữ liệu giả lập cho 20 sinh viên
-- ----------------------------------------------------------------------------

-- ============================================================================
-- PHẦN 1: KHỞI TẠO DATABASE VÀ BẢNG (SCHEMA) - GIỮ NGUYÊN CẤU TRÚC CŨ
-- ============================================================================
...
-- 2. XÓA BẢNG CŨ ĐỂ LÀM SẠCH DỮ LIỆU
...
-- ============================================================================
-- PHẦN 2: CHÈN DỮ LIỆU MẪU PHONG PHÚ (20 SINH VIÊN & ĐIỂM SỐ)
-- ============================================================================
...
-- 7. SINH VIÊN (20 bạn - Đã bổ sung thêm 5 bạn mới)
...
('SV005', 'Đỗ Thị Lan Anh',   '2003-11-05', 0, '55 Quang Trung, Gò Vấp', '0988777666', 'anh.dtl@st.edu.vn', '21SE02', 2),
-- Lớp IS01
...
('SV014', 'Nguyễn Văn Cựu',   '2000-01-01', 1, 'Đã ra trường', '0900000000', 'cuu.nv@st.edu.vn', '21SE01', 3), 
('SV015', 'Trần Văn Nghỉ',    '2003-01-01', 1, 'Không rõ', '0000000000', 'nghi.tv@st.edu.vn', '21SE02', 0),
-- === 5 SINH VIÊN MỚI ===
('SV016', 'Lê Thị Thu Hà',    '2004-05-20', 0, 'Đà Nẵng', '0911222333', 'ha.ltt@st.edu.vn', '22IS01', 1),
('SV017', 'Phan Mạnh Quỳnh',  '2004-09-09', 1, 'Nghệ An', '0922333444', 'quynh.pm@st.edu.vn', '22AI01', 1),
('SV018', 'Đen Vâu',          '2005-12-12', 1, 'Quảng Ninh', '0933444555', 'vau.d@st.edu.vn', '23MKT1', 1),
('SV019', 'Hòa Minzy',        '2005-01-30', 0, 'Bắc Ninh', '0944555666', 'minzy.h@st.edu.vn', '23IB01', 1),
('SV020', 'Đàm Vĩnh Hưng',    '2003-10-02', 1, 'TP.HCM', '0955666777', 'hung.dv@st.edu.vn', '21SE02', 1);
...
-- 11. ĐĂNG KÝ & ĐIỂM (Cập nhật đầy đủ điểm để hiển thị GPA)
-- Lớp LHP001 (Nhập môn lập trình)
...
('SV020', 'LHP001', 6.5, 7.0, 6.8, 'Đạt'); -- Đàm Vĩnh Hưng học cải thiện

-- Lớp LHP002 (Nhập môn lập trình - Lớp khác)
INSERT INTO Diem (MaSV, MaLopHP, DiemQT, DiemThi, DiemTongKet, KetQua) VALUES
('SV006', 'LHP002', 10.0, 9.5, 9.7, 'Đạt'),
('SV007', 'LHP002', 6.0, 6.0, 6.0, 'Đạt'),
('SV016', 'LHP002', 7.5, 8.0, 7.8, 'Đạt'); -- Lê Thị Thu Hà

-- Lớp LHP004 (Kinh tế vi mô) - Cho các bạn bên Kinh tế
INSERT INTO Diem (MaSV, MaLopHP, DiemQT, DiemThi, DiemTongKet, KetQua) VALUES
('SV010', 'LHP004', 8.0, 8.5, 8.3, 'Đạt'), -- Hoàng Văn Thái
('SV011', 'LHP004', 9.0, 9.0, 9.0, 'Đạt'), -- Trương Quỳnh Anh
('SV012', 'LHP004', 4.0, 5.0, 4.6, 'Rớt'), -- Sơn Tùng MTP
('SV013', 'LHP004', 7.5, 7.5, 7.5, 'Đạt'), -- Chi Pu
('SV018', 'LHP004', 8.5, 8.0, 8.2, 'Đạt'), -- Đen Vâu
('SV019', 'LHP004', 9.5, 9.5, 9.5, 'Đạt'); -- Hòa Minzy

-- Lớp LHP005 (AI - Trí tuệ nhân tạo)
INSERT INTO Diem (MaSV, MaLopHP, DiemQT, DiemThi, DiemTongKet, KetQua) VALUES
('SV008', 'LHP005', 9.5, 10.0, 9.8, 'Đạt'),
('SV009', 'LHP005', 8.5, 9.0, 8.8, 'Đạt'),
('SV017', 'LHP005', 5.0, 5.0, 5.0, 'Đạt'); -- Phan Mạnh Quỳnh (Vừa đủ đậu)
...
('SV019', 'HK1_2324', 88, 'Giỏi',     'Tham gia văn nghệ tích cực',        '2024-01-15');

SELECT 'Cài đặt Database thành công! Hãy khởi động lại ứng dụng để thấy 20 sinh viên và GPA.' AS Message;